...
import YoutubeEmbed1 from "./YoutubeEmbed1";
export default function SeedsInformation() {
  return (
  <>
  ...
  <br />
  <p>
  <p>Subsidies on inputs have their root in Green revolution. That time extensive subsidies were given on Hybrid seeds, Fertilizers, pesticides etc. main aim of subsidies are two – one is to keep cost of the food grains at minimum and avoiding food inflation, second is to ensure income security of the farmer. While this policy has helped a lot to secure food sufficiency, yet it has many unintended negative impacts. It results in overuse of inputs as inputs costs doesn’t represent adequate market costs, farmers are unable to respond to market signals. They continue to use skewed mix of inputs as costs are borne by government.</p>
  </p>
  <br />
  <ol>
    <li>
      <h3 style={{color:"orange"}}>Seeds</h3>
    </li>
    <p>
  ...
  <br />
      <h3 style={{color:"violet"}}>     Hybrid Seeds</h3>
  <p>
  Hybrid seeds are obtained by cross pollination of different varieties of related plants. These seeds were instrumental in green revolution. These seeds combine desirable properties of two related plants.One drawback was that these seeds don’t regenerate seeds of same quality. So every time farmers have to buy new seeds. In case of conventional seeds, farmers could use reproduced seeds by current crop.
  </p>
  <br/>
  
    <h3 style={{color:"violet"}}>Genetically Modified Varieties</h3>
  
  <p>
  These varieties of seeds are developed in laboratories by genetic engineering technologies. In these technologies genes of different species of organisms (like bacteria genes with plants) are integrated to modify DNA to get desired characteristic. Bacteria named bacillus Thuringiensis gives a gene that is incorporated into plant’s DNA and we get Genetically Modified Organisms like BT- corn, BT- cotton, Bt- Brinjal etcwhereas in Europe it is largely banned as of now. In India, it is allowed for commercial production of cotton and for food crops field trials are going on.
  </p>
  <br/>
  <li>
    <h3 style={{color:"orange"}}> Fertilizers and Manures</h3>
  </li>
  <p>
  <p>
...
<h3 style={{color:"voilet"}}> Fertilizers Vs Manure</h3>
<p>
...
<h3 style={{color:'violet'}}>Macronutrients and Micronutrients</h3>
<p>
...
<li>
<h3 style={{color:"orange"}}>Power and water for agriculture</h3>
</li>
<p>
...
<h3 style={{color:"violet"}}>Separation of feeders</h3>
<p>
...
<h3 style={{color:"voilet"}} >Irrigation</h3>
<p>
